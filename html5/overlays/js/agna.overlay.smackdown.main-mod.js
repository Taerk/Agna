	...
	if (design.game.enabled) {
		switch (design.sidebar.position) {
			case 0:	
				...
				break;
			default:
				agna.ctx.fillStyle = agna.colors.outline_gradient;
				agna.ctx.beginPath();
				agna.ctx.rect(0,0,agna.ctx.width,agna.ctx.height);
				agna.ctx.closePath();
				agna.ctx.fill();
				
				agna.ctx.fillStyle = '#803b3c';
				agna.ctx.beginPath();
				agna.ctx.moveTo(0,0);
				agna.ctx.lineTo(0,35);
				agna.ctx.lineTo(500,35);
				agna.ctx.lineTo(500,60);
				agna.ctx.lineTo(800,60);
				agna.ctx.lineTo(800,35);
				agna.ctx.lineTo(1280,35);
				agna.ctx.lineTo(1280,0);
				agna.ctx.closePath();
				agna.ctx.fill();
				
				agna.ctx.beginPath();
				agna.ctx.moveTo(0,720);
				agna.ctx.lineTo(0,695);
				agna.ctx.lineTo(20,695);
				agna.ctx.lineTo(20,650);
				agna.ctx.lineTo(1260,650);
				agna.ctx.lineTo(1260,695);
				agna.ctx.lineTo(1280,695);
				agna.ctx.lineTo(1280,720);
				agna.ctx.closePath();
				agna.ctx.fill();
